...
document.getElementById('deleteButton').addEventListener('click',function(){
    ...
    else {console.log(arrcheck.length);}
    ...
    $.ajax({
        ...
        success: function(){ // on ajax sunnces i.e when data is delete
            swal("Task removed ", "click ok to go back Home ", "success") // using sweet alert to show the data is delete
            .then(redir => {
                window.location = '/';
            })
   ...
   /* let url = new URL(window.location.href);
    ...
    // add the arrcheck array to the query string of the URL
    url.searchParams.set('id', arrcheck.join(','));
